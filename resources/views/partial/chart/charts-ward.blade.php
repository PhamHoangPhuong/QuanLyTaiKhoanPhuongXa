    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <script>
                ...
                //3. --------------------------------- CHART WARd DATA CIRCLE ---------------------------------
                $(document).ready(function () {
                    $('#yearSelect').on('change', function () {
                        loadCircleAjax('/chart-ward-data-circle', 'container-circle', 'total', 'series', 'Tổng dân số', $(this).val());
                    });
                });


                //4. --------------------------------- CHART WARD DATA CIRCLE_1 ---------------------------------
                $(document).ready(function () {
                    $('#yearSelect').on('change', function () {
                        loadCircleAjax('/chart-ward-data-circle-1', 'container-circle_1', 'total_1', 'series_1', 'Tổng dân số 15 đến 25 tuối' , $(this).val());
                    });
                });


                //5. --------------------------------- CHART WARD DATA CIRCLE_2 ---------------------------------
                $(document).ready(function () {
                    $('#yearSelect').on('change', function () {
                        loadCircleAjax('/chart-ward-data-circle-2', 'container-circle_2', 'total_2', 'series_2', 'Tổng dân số 15 đến 35 tuối', $(this).val());
                    });
                });


                //6. --------------------------------- CHART WARD DATA CIRCLE_3 ---------------------------------
                $(document).ready(function () {
                    $('#yearSelect').on('change', function () {
                        loadCircleAjax('/chart-ward-data-circle-3', 'container-circle_3', 'total_3', 'series_3', 'Tổng dân số 15 đến 60 tuối', $(this).val());
                    });
                });
