            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="{{ route('form.add-user') }}" class="btn btn-success btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('form.edit-user', $user->id) }}" class="btn btn-sm btn-primary">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('delete.user', $user->id) }}" method="POST" class="m-0 ml-2">
                                                @csrf
                                                @method('DELETE')
