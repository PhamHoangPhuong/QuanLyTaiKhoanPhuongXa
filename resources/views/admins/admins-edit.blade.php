                    ...
                    {{-- form-body --}}
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="form-group row col-md-6" id="wardProvinceGroup">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label for="email" class="form-label">Tỉnh</label>
                                            <select class="form-control" id="province" name="province_id">
                                                <option value=""> Thuộc tỉnh </option>
                                                @isset($provinces)
                                                    @foreach($provinces as $province)
                                                        <option value="{{ $province->province_id }}" {{ old('province_id', $user->province_id) == $province->province_id ? 'selected' : '' }}>
                                            ...
                                            <select class="form-control" id="ward" name="ward_id">
                                                ...
                                                @isset($wards)
                                                    @foreach($wards as $ward)
                                                        <option value="{{ $ward->ward_id }}" {{ old('ward_id', $user->ward_id) == $ward->ward_id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="email" class="form-label">Tỉnh</label>
                                        <select class="form-control" id="Province" name="province_id_2">
